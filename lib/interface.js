    ...
    autoValue: function() {
      if (this.isInsert){
        ...
        if (name.isSet) {
          ...
          Meteor.setTimeout(function(){}, 20000);
          var website_string = Session.get("website_string");
          var name_string = Session.get("name_string");
          var price = Session.get("price");
          var imageurl_string = Session.get("imageurl_string");
